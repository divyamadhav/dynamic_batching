...
def random_exp(res, batch, batch_size, factor, min_size=1, max_size=15):
    fails_per = 100*batch.count(0)/len(batch)
...
def stagger_update(res, batch, batch_size, factor, min_size=1, max_size=16):
